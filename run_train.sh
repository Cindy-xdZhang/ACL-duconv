...
# zxd:datatype is a array
datatype=(train dev)

# data preprocessing
#${#datatype[*]}datatype为数组长度 2
...
#得到 data/resource/sample.train.txt data/resource/sample.dev.txt 
#  ***data/demo.train  data/demo.dev 
# data/demo.train.topic  data/demo.dev.topic
# ***data/vocab.txt
...
#在训练过程中，每config.valid_steps 个batch（步）进行一次valid，并储存一次模型和最好模型
